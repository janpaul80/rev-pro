    ...
    <div style={{
      ...
      <div className="glass" style={{
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ color: '#666', fontSize: '0.9rem' }}>Log in to your Rev Pro account</p>
        </div>
        ...
        <div style={{ marginTop: '2rem', fontSize: '0.9rem', color: '#666' }}>
          Don&apos;t have an account? <Link href="/signup" style={{ color: '#fbb02e', textDecoration: 'underline' }}>Sign up</Link>
        </div>
      </div>
    </div>
  );
